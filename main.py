...
user = input('''Welcome back to Foodle! Please choose what you would like to view today.
                Type 1 to view a table of your daily intakes
                Type 2 to view a table that compares your daily intakes to the recommended intakes
                Type 3 to view a graph of the trends of your daily intakes
                Type 4 to add an entry of your daily intakes
                 ''')
